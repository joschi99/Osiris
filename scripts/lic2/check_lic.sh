...
function write_statusfile () {
	...
	echo "$LIC_STATUS_HOST,$LIC_STATUS_HOST_TEXT" >> $PATH_LICFILE/$FILE_LIC_STATUS
	echo "$LIC_STATUS_SERVICE,$LIC_STATUS_SERVICE_TEXT" >> $PATH_LICFILE/$FILE_LIC_STATUS
	echo "$LIC_STATUS_POLLER,$LIC_STATUS_POLLER_TEXT" >> $PATH_LICFILE/$FILE_LIC_STATUS
	echo "$LIC_STATUS_RANCID,$LIC_STATUS_RANCID_TEXT" >> $PATH_LICFILE/$FILE_LIC_STATUS
	echo "$LIC_STATUS_NEDI,$LIC_STATUS_NEDI_TEXT" >> $PATH_LICFILE/$FILE_LIC_STATUS
	echo "$LIC_STATUS_SYSLOG,$LIC_STATUS_SYSLOG_TEXT" >> $PATH_LICFILE/$FILE_LIC_STATUS
	echo "$LIC_STATUS_GLPI,$LIC_STATUS_GLPI_TEXT" >> $PATH_LICFILE/$FILE_LIC_STATUS

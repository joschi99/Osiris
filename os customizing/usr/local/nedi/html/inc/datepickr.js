/*
    ...
    Copyright (c) 2012 josh.salverda (https://code.google.com/p/datepickr/)
*/
...
var datepickr = (function() {
	...
	function formatDate(milliseconds, config) {
		...
		//currentDate = new Date()
		return formattedDate + ' ' + currentDate.getHours() + ':00';
	}
...
/*		if(obj.offsetParent) {
		...
		Replaced by r2 because it didn't work for inputs on right side of GUI:
*/
//		alert( obj.id );
		var rectObject = rect = obj.getBoundingClientRect();
//		console.log(rect.top, rect.right, rect.bottom, rect.left);
		if( rect.left > 500 ) inputLeft = -200;
		inputLeft += rect.right;
		inputTop += rect.top;

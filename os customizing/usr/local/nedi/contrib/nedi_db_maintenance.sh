...
case $# in
	...
	*)
		...
		echo -e "05.06.2015, rickli (adopted tables)"
		echo -e "--------------------------------------\n"
...
query+=("
OPTIMIZE TABLE chat,configs,devices,dns,dns6,events,iftrack,incidents,install,interfaces,inventory,iptrack,links,locations,modules,monitoring,networks,nodarp,nodes,nodnd,policies,system,users,vlans,wlan;
#optimizing tables")

query+=("
ANALYZE TABLE chat,configs,devices,dns,dns6,events,iftrack,incidents,install,interfaces,inventory,iptrack,links,locations,modules,monitoring,networks,nodarp,nodes,nodnd,policies,system,users,vlans,wlan;
#analyzing tables")
